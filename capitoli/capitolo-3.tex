...
Il modello delle classi di dominio descrive entità e concetti propri dell'area funzionale che il sistema dovrà implementare.
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.81\textwidth]
		{immagini/cd-sistema}
  ...
  \subparagraph*{N.B.}
  Al fine della leggibilità del diagramma delle classi si è scelto di non inserire i metodi delle varie classi. I metodi delle classi sono specificati nel modello di design delle classi \emph{Entity} a pagina \pageref{c4:classi-entity}.